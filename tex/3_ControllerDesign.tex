...
Discretizing this equation using the Forward Euler method with sampling time $T_s$ of the DC control loop yields the discrete-time 
prediction model:
\begin{equation}
...
\end{equation}
This imposes "box constraints" on the $d$ and $q$ axis currents for the active control moves. Since the inputs beyond $N_c$ are
