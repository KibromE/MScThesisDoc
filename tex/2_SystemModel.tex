...
The derivation and Implementation of the symmetrical sequence decomposition is given in appendix A.
\begin{equation}
    \begin{gathered}
...
Thus the space vector of the unbalanced system can be transformed using the Clarke transformation as given in appendix B
...
rotating frame using the Park transformation as given in appendix B. The system can be represented in the synchronous d-q frame as follows:
\begin{equation}
    \begin{split}
        \frac{d}{dt}
        \begin{bmatrix}
